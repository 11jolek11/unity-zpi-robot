...
public class RobotAgent : Agent
{
    ...
    {
        // Odleg³oœæ i kierunek do sygna³u Wi-Fi
        if (wifiSignal != null)
        {
        ...
        {
            sensor.AddObservation(10f); // Maksymalna odleg³oœæ dla braku przeszkód
        }

        // Obserwacje prêdkoœci
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        // Nagroda za zbli¿enie siê do sygna³u Wi-Fi
        AddReward(-0.01f); // Negatywna nagroda za ka¿d¹ klatkê
